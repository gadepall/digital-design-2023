...
\input{./assembly/7447/io/figs/components.tex}
\fi
...
\item Make connections between the 7447 and the arduino according to Table \ref{table:assembly/7447/count/7447_ard}
%
%\begin{table}[!h]
%\centering
%\input{./assembly/7447/io/figs/7447_ard.tex}
%\caption{}
