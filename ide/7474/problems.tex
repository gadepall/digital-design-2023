...
\item The synchronous sequential circuit shown below works at a clock frequency of $\qty{
    1}{\giga\hertz}$. The throughput, in $\SI{}{\mega\bit\per\second}$ and the latency, in $ns$,
     respectively, are
