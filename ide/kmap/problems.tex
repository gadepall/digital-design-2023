...
\hfill(GATE IN 2019)
 ...
 \item 
  ...
  Consider the minterm list form of a Boolean function given below.$F(P, Q, R, S) = \sum m(0, 2, 5, 7, 9, 11) + d(3, 8, 10, 12, 14)$ Here, denotes a minterm and denotes a don’t care term. The number of essential prime implicants of the function is
\hfill(GATE CS 2018)
\end{enumerate}
