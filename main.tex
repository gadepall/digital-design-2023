...
\section{Problems}
\input{assembly/Assembly_problems.tex}
\chapter{Embedded C}
\section{Blink}
...
\section{Problems}
\input{vaman/esp32/lcd/problem.tex}
\chapter{Vaman-FPGA}
\section{Setup}
...
\chapter{Picoprobe}
\section{Setup}
\input{picoprobe/setup/picoprobe.tex}
\section{Raspberry Pi Pico}
\input{picoprobe/rpi/rpi.tex}
\section{Vaman}
\input{picoprobe/vaman/vaman.tex}
\backmatter
\appendix
\chapter{Raspberry Pi - Vaman ESP32 through UART}
\input{rpi/main.tex}
\iffalse
\chapter{Manual}
