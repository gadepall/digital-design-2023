...
\item The necessary components for this manual are listed in Table \ref{table:/stm32/clocks/components}.
\begin{table}[!ht]
\centering
\input{./stm32/clocks/figs/components.tex}
\caption{Components}
\label{table:/stm32/clocks/components}
\end{table}
