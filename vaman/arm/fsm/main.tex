...
Fig. \ref{fig:sevenseg} and Table \ref{tab:vaman/arm/fsm/vaman_dispdec}.  Do not forget to put a resistor between COM and 3.3V.  Then execute the following code 
\begin{lstlisting}
