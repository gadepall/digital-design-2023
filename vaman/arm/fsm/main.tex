...
%\begin{table}
%\centering
%\input{./vaman/arm/fsm/tables/disp_dec.tex}
...
\item Table \ref{tab:ide/7447/counter_decoder} shows the logic for the incrementing decoder.  Express $A,B,C,D$ in terms of $W,X,Y,Z$.
\label{prob:vaman/arm/fsm/counter_decoder}
%\begin{table}
%\centering
%\input{./vaman/arm/fsm/tables/counter_decoder.tex}
...
%
\item Fig. \ref{fig:vaman/fpga/setup/pin_sheet} shows the pin diagram for the Vaman.  Connect the pins in bank J5 to the seven segment display using
Fig. \ref{fig:sevenseg} and Table \ref{tab:vaman/fpga/boolean/vaman_dispdec}.  Do not forget to put a resistor between COM and 3.3V.  Then execute the following code 
\begin{lstlisting}
...
%\input{vaman/arm/fsm/tables/pygmy_sevenseg.tex}
%}
%\hfill
%\parbox{.45\columnwidth}{
%\resizebox{0.5\columnwidth}{!}{
%\input{vaman/arm/fsm/tables/Vaman_dispdec.tex}
%\input{vaman/arm/fsm/tables/pygmy_dispdec.tex}
%}
...
%\input{vaman/arm/fsm/figs/sevenseg.tex}
%}
...
\item Use the Vaman to implement all the decoders in Fig.  \ref{fig:decade_counter}.  Implement the delay using a flip flop.  This is an 
...
%\centering
%\resizebox{\columnwidth}{!}{
%\input{vaman/arm/fsm/figs/pygmy_decade_counter.tex}
%}
