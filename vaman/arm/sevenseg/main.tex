...
display in Fig.  \ref{fig:sevenseg} to bank J5 of the Vaman using Table \ref{tab:vaman/arm/sevenseg/sevenseg}.
...
\end{lstlisting}
\item Modify the above program using Table \ref{tab:vaman/arm/sevenseg/arduinoport} and Fig. \ref{fig:sevenseg12}
to display 0-9.
\begin{table}[!ht]
\centering
\resizebox{\columnwidth}{!}{
