...
\item Fig.\ref{fig:vaman/arm/sevenseg/pin_sheet} shows all the pin banks of the Vaman. Connect the pins of the
display in Fig.  \ref{fig:vaman/arm/sevenseg/sevenseg} to bank J5 of the Vaman using Table \ref{tab:vaman/arm/sevenseg/sevenseg}.
The COM pin should be connected to 3.3V through a resistor.
\begin{table}[!ht]
\centering
\resizebox{\columnwidth}{!}{
\input{vaman/arm/sevenseg/tables/Vaman_sevenseg.tex}
}
\caption{Display-Vaman connection.}
\label{tab:vaman/arm/sevenseg/sevenseg}
\end{table}

\begin{figure}[!ht]
\centering
\resizebox{\columnwidth}{!}{
\input{vaman/arm/sevenseg/figs/sevenseg.tex}
}
\caption{Seven Segment Display}
\label{fig:vaman/arm/sevenseg/sevenseg}
\end{figure}
\begin{figure}[!ht]
\centering
\resizebox{\columnwidth}{!}{
\input{vaman/arm/sevenseg/figs/sevenseg12.tex}
}
\caption{Pictorial representation of Table \ref{tab:vaman/arm/sevenseg/arduinoport}.}
\label{fig:vaman/arm/sevenseg/sevenseg12}
\end{figure}


\begin{figure*}[!ht]
\centering
\includegraphics[width = \textwidth]{vaman/arm/sevenseg/figs/pin_sheet.png}
\caption{Pin Diagram}
\label{fig:vaman/arm/sevenseg/pin_sheet}
\end{figure*}



\item Now execute the following code
\label{code:vaman/arm/sevenseg/sevenseg}
\begin{lstlisting}
...
\end{lstlisting}
\item Modify the above program using Table \ref{tab:vaman/arm/sevenseg/arduinoport} and Fig. \ref{fig:vaman/arm/sevenseg/sevenseg12} 
to display 0-9.
\begin{table}[!ht]
\centering
\resizebox{\columnwidth}{!}{
\input{vaman/arm/sevenseg/tables/arduinoport.tex}
}
\caption{Decimal number generation on the display. }
\label{tab:vaman/arm/sevenseg/arduinoport}
\end{table}
\end{enumerate}
%
\subsection{Examples}
...
\item   Table \ref{tab:vaman/arm/sevenseg/sevenseg} and PU 64 Table in 
Fig.  \ref{fig:vaman/arm/sevenseg/pins}  show how to use the pins of the Vaman to drive the seven segment display.
%इसमें संशोधन कर वामन के कुशों के अनेक संचय के लिए क्रमादेश \ref{code:vaman/arm/sevenseg/sevenseg} का चालयन करें.
\begin{figure*}[!ht]
\centering
\includegraphics[width = \textwidth]{vaman/arm/sevenseg/figs/pins.jpg}
\caption{Pin map.}
\label{fig:vaman/arm/sevenseg/pins}
\end{figure*}
\item Use a function taking decimal input in the code in  \ref{code:vaman/arm/sevenseg/sevenseg} to generate 
