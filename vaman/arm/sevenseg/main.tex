...
\item Fig.\ref{fig:vaman/fpga/setup/pin_sheet} shows all the pin banks of the Vaman. Connect the pins of the
...
Fig.  \ref{fig:vaman/fpga/sevenseg/pins}  show how to use the pins of the Vaman to drive the seven segment display.
