...
\item Fig. \ref{fig:vaman/fpga/boolean/pin_sheet} shows the pin diagram for the Vaman.  Using the bank J5, connect the pins of  the seven segment display in Fig. \ref{fig:vaman/fpga/boolean/sevenseg} to the Vaman according to Table  \ref{tab:vaman/fpga/boolean/vaman_dispdec}.  Make sure that the COM pin is connected to 3.3V through a resistor.
\begin{table}[!ht]
\centering
\parbox{.45\columnwidth}{
%\resizebox{0.5\columnwidth}{!}{
\input{vaman/fpga/boolean/tables/pygmy_sevenseg.tex}
}
\hfill
\parbox{.45\columnwidth}{
%\resizebox{0.5\columnwidth}{!}{
\input{vaman/fpga/boolean/tables/pygmy_dispdec.tex}
}
...
\input{vaman/fpga/boolean/figs/sevenseg.tex}
}
...
\begin{table}
\centering
\input{./vaman/fpga/boolean/tables/disp_dec.tex}
...
\begin{table}
\centering
\input{./vaman/fpga/boolean/tables/counter_decoder.tex}
...
\item Using Fig. \ref{fig:vaman/fpga/boolean/vaman_decade_counter} and modifying the code in Problem \ref{prob:counter_decoder}, design the decade counter.
\begin{figure}[!ht]
\centering
\resizebox{\columnwidth}{!}{
\input{vaman/fpga/boolean/figs/pygmy_decade_counter.tex}
}
